...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=CIESNIH\\SQLSEVERNO1;Database=BTLWEBAPI;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<CongTy>(entity =>
        {
            entity.HasKey(e => e.MaCongTy).HasName("PK__CongTy__E452D3DB7394C80A");

            entity.ToTable("CongTy");

            entity.HasIndex(e => e.Slug, "UQ__CongTy__BC7B5FB62E9E33D2").IsUnique();
            ...
            entity.HasOne(d => d.TaoBoiNavigation).WithMany(p => p.CongTies)
                ...
                .HasConstraintName("FK__CongTy__TaoBoi__44FF419A");
        });

        modelBuilder.Entity<DonUngTuyen>(entity =>
        {
            entity.HasKey(e => e.MaDon).HasName("PK__DonUngTu__3D89F5682342715C");
        ...
        modelBuilder.Entity<HoSo>(entity =>
        {
            ...
            entity.HasOne(d => d.MaUngVienNavigation).WithMany(p => p.HoSos)
                .HasForeignKey(d => d.MaUngVien)
                .HasConstraintName("FK__HoSo__MaUngVien__6383C8BA");
        });

        modelBuilder.Entity<KyNang>(entity =>
        {
            entity.HasKey(e => e.MaKyNang).HasName("PK__KyNang__796CFDAF33CD485B");

            entity.ToTable("KyNang");

            entity.HasIndex(e => e.TenKyNang, "UQ__KyNang__89D6F06DB41C9881").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaLog).HasName("PK__LichSuHe__3B98D24AC4C5C35A");
            ...
            entity.HasOne(d => d.MaNguoiTacDongNavigation).WithMany(p => p.LichSuHeThongs)
                ...
                .HasConstraintName("FK__LichSuHeT__MaNgu__06CD04F7");
        });

        modelBuilder.Entity<NguoiDung>(entity =>
        {
            entity.HasKey(e => e.MaNguoiDung).HasName("PK__NguoiDun__C539D76255D948C7");

            entity.ToTable("NguoiDung");

            entity.HasIndex(e => e.Email, "UQ__NguoiDun__A9D1053472EE785E").IsUnique();
            ...
            entity.HasOne(d => d.MaQuyenNavigation).WithMany(p => p.NguoiDungs)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__NguoiDung__MaQuy__3E52440B");
        });

        modelBuilder.Entity<PhongVan>(entity =>
        {
            entity.HasKey(e => e.MaPhongVan).HasName("PK__PhongVan__C7954C395A69F5DC");
            ...
            entity.HasOne(d => d.MaDonNavigation).WithMany(p => p.PhongVans)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PhongVan__MaDon__73BA3083");

            entity.HasOne(d => d.MaNguoiPhongVanNavigation).WithMany(p => p.PhongVans)
                .HasForeignKey(d => d.MaNguoiPhongVan)
                .HasConstraintName("FK__PhongVan__MaNguo__74AE54BC");
        });

        modelBuilder.Entity<Quyen>(entity =>
        {
            entity.HasKey(e => e.MaQuyen).HasName("PK__Quyen__1D4B7ED4DA3A1D00");

            entity.ToTable("Quyen");

            entity.HasIndex(e => e.TenQuyen, "UQ__Quyen__5637EE793AB661A1").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaThongBao).HasName("PK__ThongBao__04DEB54E4AEF5548");
            ...
            entity.HasOne(d => d.MaNguoiNhanNavigation).WithMany(p => p.ThongBaos)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ThongBao__MaNguo__02FC7413");
        });

        modelBuilder.Entity<ThuMoiLamViec>(entity =>
        {
            entity.HasKey(e => e.MaOffer).HasName("PK__ThuMoiLa__F10C0C47A2395699");

            entity.ToTable("ThuMoiLamViec");

            entity.HasIndex(e => e.MaDon, "UQ__ThuMoiLa__3D89F56994B681C1").IsUnique();
            ...
            entity.HasOne(d => d.MaDonNavigation).WithOne(p => p.ThuMoiLamViec)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ThuMoiLam__MaDon__7C4F7684");

            entity.HasOne(d => d.MaNguoiGuiNavigation).WithMany(p => p.ThuMoiLamViecs)
                .HasForeignKey(d => d.MaNguoiGui)
                .HasConstraintName("FK__ThuMoiLam__MaNgu__7D439ABD");
        });

        modelBuilder.Entity<UngVien>(entity =>
        {
            entity.HasKey(e => e.MaUngVien).HasName("PK__UngVien__8FDBA8A9899ADBAD");

            entity.ToTable("UngVien");

            entity.HasIndex(e => e.MaNguoiDung, "UQ__UngVien__C539D763DDC53C9F").IsUnique();
            ...
            entity.HasOne(d => d.MaNguoiDungNavigation).WithOne(p => p.UngVien)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__UngVien__MaNguoi__5DCAEF64");
        });

        modelBuilder.Entity<ViecLam>(entity =>
        {
            entity.HasKey(e => e.MaViecLam).HasName("PK__ViecLam__8648CD60431DB6E2");

            entity.ToTable("ViecLam");

            entity.HasIndex(e => e.Slug, "UQ__ViecLam__BC7B5FB6B1092019").IsUnique();
            ...
            entity.HasOne(d => d.MaCongTyNavigation).WithMany(p => p.ViecLams)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ViecLam__MaCongT__4F7CD00D");

            entity.HasOne(d => d.TaoBoiNavigation).WithMany(p => p.ViecLams)
                .HasForeignKey(d => d.TaoBoi)
                .HasConstraintName("FK__ViecLam__TaoBoi__5070F446");
            ...
            entity.HasMany(d => d.MaKyNangs).WithMany(p => p.MaViecLams)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<KyNang>().WithMany()
                        ...
                        .HasConstraintName("FK__ViecLam_K__MaKyN__571DF1D5"),
                    l => l.HasOne<ViecLam>().WithMany()
                        .HasForeignKey("MaViecLam")
                        .HasConstraintName("FK__ViecLam_K__MaVie__5629CD9C"),
                    j =>
                    {
                        j.HasKey("MaViecLam", "MaKyNang").HasName("PK__ViecLam___61DE02BA00909835");
